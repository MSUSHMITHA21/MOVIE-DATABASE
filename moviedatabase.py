...
(30), year int(30))")
rows=[('Lovestory', 'Naga Chaitanya', 'Sai Pallavi', 'Shkehar Kammula', 2021),
       ('Gabbar Singh' , 'Pawan Kalyan', 'Sruthi Hasan', 'Harish Shankar', 2012),
      ('Majnu', 'Nani', 'Anu Emmanuel', 'Virinchi Varma', '2016')]
